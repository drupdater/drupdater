...
func (_m *MockRunner) Run(ctx context.Context, dir string) (string, error) {
...
func (_c *MockRunner_Run_Call) RunAndReturn(run func(context.Context, string) (string, error)) *MockRunner_Run_Call {
	_c.Call.Return(run)
	return _c
}
