...
// ConfigureDatabase provides a mock function for the type MockSettingsService
func (_mock *MockSettingsService) ConfigureDatabase(ctx context.Context, dir string, site string) error {
...
func (_c *MockSettingsService_ConfigureDatabase_Call) Return(err error) *MockSettingsService_ConfigureDatabase_Call {
	_c.Call.Return(err)
	return _c
}

func (_c *MockSettingsService_ConfigureDatabase_Call) RunAndReturn(run func(ctx context.Context, dir string, site string) error) *MockSettingsService_ConfigureDatabase_Call {
	_c.Call.Return(run)
	return _c
}

// RemoveProfile provides a mock function for the type MockSettingsService
func (_mock *MockSettingsService) RemoveProfile(ctx context.Context, dir string, site string) error {
	ret := _mock.Called(ctx, dir, site)
...
func (_c *MockSettingsService_RemoveProfile_Call) Return(err error) *MockSettingsService_RemoveProfile_Call {
	_c.Call.Return(err)
	return _c
}

func (_c *MockSettingsService_RemoveProfile_Call) RunAndReturn(run func(ctx context.Context, dir string, site string) error) *MockSettingsService_RemoveProfile_Call {
	_c.Call.Return(run)
	return _c
}
