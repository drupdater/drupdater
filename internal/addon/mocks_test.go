...
func (_c *MockComposer_GetDependencyPatches_Call) Return(mapMapBool map[string]map[string]bool, err error) *MockComposer_GetDependencyPatches_Call {
	_c.Call.Return(mapMapBool, err)
	return _c
}
