...
func (_c *MockEventDispatcher_FireEvent_Call) RunAndReturn(run func(event.Event) error) *MockEventDispatcher_FireEvent_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *MockEventDispatcher_AddSubscriber_Call) RunAndReturn(run func(event.Subscriber)) *MockEventDispatcher_AddSubscriber_Call {
	_c.Call.Return(run)
	return _c
}
