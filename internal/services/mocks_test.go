...
// Version provides a mock function for the type MockComposer
func (_mock *MockComposer) Version(ctx context.Context) (composer.Versions, error) {
	...
	var r0 composer.Versions
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context) (composer.Versions, error)); ok {
		return returnFunc(ctx)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context) composer.Versions); ok {
		r0 = returnFunc(ctx)
	} else {
		r0 = ret.Get(0).(composer.Versions)
	}
...
// MockComposer_Version_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Version'
type MockComposer_Version_Call struct {
	*mock.Call
}

// Version is a helper method to define mock.On call
//   - ctx context.Context
func (_e *MockComposer_Expecter) Version(ctx any) *MockComposer_Version_Call {
	return &MockComposer_Version_Call{Call: _e.mock.On("Version", ctx)}
}

func (_c *MockComposer_Version_Call) Run(run func(ctx context.Context)) *MockComposer_Version_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockComposer_Version_Call) Return(versions composer.Versions, err error) *MockComposer_Version_Call {
	_c.Call.Return(versions, err)
	return _c
}

func (_c *MockComposer_Version_Call) RunAndReturn(run func(ctx context.Context) (composer.Versions, error)) *MockComposer_Version_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_mock *MockRepository) CloneRepository(repository string, branch string, token string, username string, email string) (repo.Repository, repo.Worktree, string, error) {
	...
	var r2 string
	var r3 error
	if returnFunc, ok := ret.Get(0).(func(string, string, string, string, string) (repo.Repository, repo.Worktree, string, error)); ok {
		return returnFunc(repository, branch, token, username, email)
	}
	if returnFunc, ok := ret.Get(0).(func(string, string, string, string, string) repo.Repository); ok {
	...
	if returnFunc, ok := ret.Get(1).(func(string, string, string, string, string) repo.Worktree); ok {
...
func (_c *MockRepository_CloneRepository_Call) Return(repository1 repo.Repository, worktree repo.Worktree, s string, err error) *MockRepository_CloneRepository_Call {
	_c.Call.Return(repository1, worktree, s, err)
	return _c
}

func (_c *MockRepository_CloneRepository_Call) RunAndReturn(run func(repository string, branch string, token string, username string, email string) (repo.Repository, repo.Worktree, string, error)) *MockRepository_CloneRepository_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *MockPlatform_CreateMergeRequest_Call) Return(mergeRequest codehosting.MergeRequest, err error) *MockPlatform_CreateMergeRequest_Call {
...
// NewMockComposerVersionReporter creates a new instance of MockComposerVersionReporter. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewMockComposerVersionReporter(t interface {
	mock.TestingT
	Cleanup(func())
}) *MockComposerVersionReporter {
	mock := &MockComposerVersionReporter{}
	mock.Mock.Test(t)
...
// MockComposerVersionReporter is an autogenerated mock type for the ComposerVersionReporter type
type MockComposerVersionReporter struct {
	mock.Mock
}

type MockComposerVersionReporter_Expecter struct {
	mock *mock.Mock
}

func (_m *MockComposerVersionReporter) EXPECT() *MockComposerVersionReporter_Expecter {
	return &MockComposerVersionReporter_Expecter{mock: &_m.Mock}
}

// Version provides a mock function for the type MockComposerVersionReporter
func (_mock *MockComposerVersionReporter) Version(ctx context.Context) (composer.Versions, error) {
	ret := _mock.Called(ctx)
...
// MockComposerVersionReporter_Version_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Version'
type MockComposerVersionReporter_Version_Call struct {
	*mock.Call
}

// Version is a helper method to define mock.On call
//   - ctx context.Context
func (_e *MockComposerVersionReporter_Expecter) Version(ctx any) *MockComposerVersionReporter_Version_Call {
	return &MockComposerVersionReporter_Version_Call{Call: _e.mock.On("Version", ctx)}
}

func (_c *MockComposerVersionReporter_Version_Call) Run(run func(ctx context.Context)) *MockComposerVersionReporter_Version_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockComposerVersionReporter_Version_Call) Return(versions composer.Versions, err error) *MockComposerVersionReporter_Version_Call {
	_c.Call.Return(versions, err)
	return _c
}

func (_c *MockComposerVersionReporter_Version_Call) RunAndReturn(run func(ctx context.Context) (composer.Versions, error)) *MockComposerVersionReporter_Version_Call {
	_c.Call.Return(run)
	return _c
}
