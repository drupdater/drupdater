...
// CheckPatchApplies provides a mock function with given fields: ctx, packageName, packageVersion, patchPath
func (_m *MockComposerService) CheckPatchApplies(ctx context.Context, packageName string, packageVersion string, patchPath string) (bool, error) {
...
//   - patchPath string
func (_e *MockComposerService_Expecter) CheckPatchApplies(ctx interface{}, packageName interface{}, packageVersion interface{}, patchPath interface{}) *MockComposerService_CheckPatchApplies_Call {
	return &MockComposerService_CheckPatchApplies_Call{Call: _e.mock.On("CheckPatchApplies", ctx, packageName, packageVersion, patchPath)}
}

func (_c *MockComposerService_CheckPatchApplies_Call) Run(run func(ctx context.Context, packageName string, packageVersion string, patchPath string)) *MockComposerService_CheckPatchApplies_Call {
...
func (_c *MockComposerService_CheckPatchApplies_Call) RunAndReturn(run func(context.Context, string, string, string) (bool, error)) *MockComposerService_CheckPatchApplies_Call {
	_c.Call.Return(run)
	return _c
}
...
// GetComposerUpdates provides a mock function with given fields: ctx, dir, packagesToUpdate, minimalChanges
func (_m *MockComposerService) GetComposerUpdates(ctx context.Context, dir string, packagesToUpdate []string, minimalChanges bool) ([]PackageChange, error) {
...
//   - minimalChanges bool
func (_e *MockComposerService_Expecter) GetComposerUpdates(ctx interface{}, dir interface{}, packagesToUpdate interface{}, minimalChanges interface{}) *MockComposerService_GetComposerUpdates_Call {
	return &MockComposerService_GetComposerUpdates_Call{Call: _e.mock.On("GetComposerUpdates", ctx, dir, packagesToUpdate, minimalChanges)}
}

func (_c *MockComposerService_GetComposerUpdates_Call) Run(run func(ctx context.Context, dir string, packagesToUpdate []string, minimalChanges bool)) *MockComposerService_GetComposerUpdates_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockComposerService_GetComposerUpdates_Call) RunAndReturn(run func(context.Context, string, []string, bool) ([]PackageChange, error)) *MockComposerService_GetComposerUpdates_Call {
	_c.Call.Return(run)
	return _c
}
...
// RunComposerAudit provides a mock function with given fields: ctx, dir
func (_m *MockComposerService) RunComposerAudit(ctx context.Context, dir string) (ComposerAudit, error) {
	ret := _m.Called(ctx, dir)
...
//   - ctx context.Context
//   - dir string
func (_e *MockComposerService_Expecter) RunComposerAudit(ctx interface{}, dir interface{}) *MockComposerService_RunComposerAudit_Call {
	return &MockComposerService_RunComposerAudit_Call{Call: _e.mock.On("RunComposerAudit", ctx, dir)}
}

func (_c *MockComposerService_RunComposerAudit_Call) Run(run func(ctx context.Context, dir string)) *MockComposerService_RunComposerAudit_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string))
	})
	return _c
...
func (_c *MockComposerService_RunComposerAudit_Call) RunAndReturn(run func(context.Context, string) (ComposerAudit, error)) *MockComposerService_RunComposerAudit_Call {
	_c.Call.Return(run)
	return _c
}
