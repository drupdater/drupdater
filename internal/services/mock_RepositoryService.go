...
// GetPatch provides a mock function with given fields: from, to
func (_m *MockRepositoryService) GetPatch(from *object.Commit, to *object.Commit) string {
	...
	var r0 string
	if rf, ok := ret.Get(0).(func(*object.Commit, *object.Commit) string); ok {
		r0 = rf(from, to)
	} else {
		r0 = ret.Get(0).(string)
	}
...
// MockRepositoryService_GetPatch_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetPatch'
type MockRepositoryService_GetPatch_Call struct {
	*mock.Call
}
...
//   - from *object.Commit
//   - to *object.Commit
func (_e *MockRepositoryService_Expecter) GetPatch(from interface{}, to interface{}) *MockRepositoryService_GetPatch_Call {
	return &MockRepositoryService_GetPatch_Call{Call: _e.mock.On("GetPatch", from, to)}
}

func (_c *MockRepositoryService_GetPatch_Call) Run(run func(from *object.Commit, to *object.Commit)) *MockRepositoryService_GetPatch_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*object.Commit), args[1].(*object.Commit))
	})
	return _c
}

func (_c *MockRepositoryService_GetPatch_Call) Return(_a0 string) *MockRepositoryService_GetPatch_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockRepositoryService_GetPatch_Call) RunAndReturn(run func(*object.Commit, *object.Commit) string) *MockRepositoryService_GetPatch_Call {
	_c.Call.Return(run)
	return _c
}
