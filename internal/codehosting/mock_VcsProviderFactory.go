...
// Create provides a mock function for the type MockVcsProviderFactory
func (_mock *MockVcsProviderFactory) Create(repositoryURL string, token string) Platform {
	ret := _mock.Called(repositoryURL, token)
	...
	var r0 Platform
	if returnFunc, ok := ret.Get(0).(func(string, string) Platform); ok {
		r0 = returnFunc(repositoryURL, token)
	} else {
		if ret.Get(0) != nil {
...
func (_c *MockVcsProviderFactory_Create_Call) Return(platform Platform) *MockVcsProviderFactory_Create_Call {
	_c.Call.Return(platform)
	return _c
}

func (_c *MockVcsProviderFactory_Create_Call) RunAndReturn(run func(repositoryURL string, token string) Platform) *MockVcsProviderFactory_Create_Call {
	_c.Call.Return(run)
	return _c
}
